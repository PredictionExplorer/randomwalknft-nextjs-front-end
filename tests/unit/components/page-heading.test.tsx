...
describe("PageHeading", () => {
  it("renders title parts", () => {
    render(<PageHeading title={[{ text: "Hello" }, { text: "World" }]} />);
  ...
  it("renders eyebrow when provided", () => {
    render(<PageHeading eyebrow="Featured" title={[{ text: "Title" }]} />);

    expect(screen.getByText("Featured")).toBeInTheDocument();
  });

  it("renders description when provided", () => {
    render(<PageHeading title={[{ text: "Title" }]} description="A short description of the page." />);

    expect(screen.getByText("A short description of the page.")).toBeInTheDocument();
  });

  it("does not render eyebrow when omitted", () => {
    render(<PageHeading title={[{ text: "Title" }]} />);
  ...
  it("applies secondary tone style", () => {
    render(<PageHeading title={[{ text: "Secondary", tone: "secondary" }]} />);
  ...
  it("applies default tone when tone is omitted", () => {
    render(<PageHeading title={[{ text: "Default" }]} />);
