...
class ApiService {
  ...
  public async get(token_id: number | string) {
    ...
    const url = `https://198.58.105.159:9094/api/rwalk/tokens/history/${token_id}/0x895a6F444BE4ba9d124F61DF736605792B35D66b/0/1000`;
  ...
  public async get_info(token_id: number | string) {
    const url = `https://198.58.105.159:9094/api/rwalk/tokens/info/0x895a6F444BE4ba9d124F61DF736605792B35D66b/${token_id}`;
