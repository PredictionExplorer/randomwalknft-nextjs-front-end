...
export default function DetailErrorPage({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <PageShell className="flex min-h-[60vh] flex-col items-center justify-center space-y-8 py-16 text-center">
      <PageHeading
        ...
        title={[{ text: "COULD NOT" }, { text: "LOAD", tone: "primary" }, { text: "DETAIL", tone: "secondary" }]}
