      ...
      >
        ...
        <div
          style={{
            ...
            padding: "56px 48px",
            background:
              "radial-gradient(circle at top right, rgba(198,118,215,0.28), transparent 55%)"
          }}
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ fontSize: 22, color: "#c676d7", letterSpacing: "0.3em" }}>
              RANDOM WALK NFT
            </div>
            <div style={{ fontSize: 64, fontWeight: 700, marginTop: 20 }}>{displayId}</div>
            {tokenName ? (
              <div style={{ fontSize: 32, color: "#f4bfff", marginTop: 12 }}>“{tokenName}”</div>
            ) : null}
            <div style={{ fontSize: 24, color: "#b3a6bb", marginTop: 24, lineHeight: 1.5 }}>
              A one-of-a-kind generative artwork drawn from an on-chain seed. One still, two
              films. CC0 public domain.
            </div>
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ fontSize: 20, color: "#9b8ba3", letterSpacing: "0.2em" }}>
              MINTED ON ARBITRUM
            </div>
