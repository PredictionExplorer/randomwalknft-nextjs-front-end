      ...
      <section className="relative flex min-h-[calc(100svh-4.5rem)] flex-col justify-end overflow-hidden">
        ...
        <PageShell className="relative z-10 pb-14 pt-40">
          <div className="max-w-3xl space-y-6">
            <p className="text-xs uppercase tracking-[0.32em] text-secondary/90">
              A living museum of generative art
            </p>
            ...
            <p className="max-w-2xl text-base leading-8 text-foreground/90 sm:text-lg">
              Random Walk NFT is a generative art collection on Arbitrum, running since 2021. Every
              mint draws a one-of-a-kind artwork from an on-chain seed, releases it to the public
              domain, and feeds a growing ETH vault that pays out to the last minter standing.
            </p>
      ...
      <PageShell className="space-y-24 pb-24 pt-20">
        ...
        <section className="space-y-10" data-testid="homepage-wall">
          <div className="space-y-3">
            <p className="text-xs uppercase tracking-[0.32em] text-secondary/80">
            ...
            <p className="max-w-3xl text-base leading-7 text-muted-foreground">
              Each token is six works in one: a high-resolution still and two films — a single
              walker and a triple walker — each rendered on black and on white. Hover any frame to
              see it move.
            </p>
          </div>
          <WallRow
            ...
            href={"/gallery?sortBy=beauty" as Route}
        ...
        <section className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          <div className="space-y-5">
            ...
            <p className="text-base leading-8 text-muted-foreground">
              A random walk is a path built one random step at a time — up, down, left, or right —
              repeated millions of times. Each Random Walk NFT starts from a seed created by your
              mint transaction and stored on-chain forever. A SHA3-256 hash stream turns that seed
              into steps, while three color channels drift alongside, so the shape and the palette
              of every work are born together from the same randomness.
            </p>
            <p className="text-base leading-8 text-muted-foreground">
              The canvas beside this text is not a recording — it is the real algorithm, drawing a
              fresh walk in your browser right now.
            </p>
          ...
          <div className="space-y-8">
            <div className="space-y-3">
              ...
              <p className="max-w-3xl text-base leading-8 text-muted-foreground">
                Every mint pays into a vault inside the smart contract — the creators take nothing.
                The most recent minter holds the vault&apos;s only key. If 30 days pass without a new
                mint, the keyholder may withdraw half of everything inside; any new mint resets the
                clock and takes the key.
                {vault && prizeRatio
          ...
          <section className="space-y-8">
            <div className="space-y-3 text-center">
              ...
              <p className="mx-auto max-w-2xl text-base leading-7 text-muted-foreground">
                The museum curates itself: visitors compare works two at a time, and every vote
                shapes the beauty ranking of the whole collection.
              </p>
            </div>
        ...
        <section className="space-y-8">
          <div className="space-y-3">
            ...
            <h2 className="text-3xl font-semibold tracking-[0.08em] sm:text-4xl">
              A MUSEUM THAT RUNS ITSELF
            </h2>
            <p className="max-w-3xl text-base leading-7 text-muted-foreground">
              No admin keys, no creator fees, no dependence on this website. These guarantees are
              enforced by the verified contract at{" "}
              <ExternalLink
        ...
        <section className="rounded-3xl border border-border/60 bg-[radial-gradient(circle_at_80%_0%,rgba(155,74,175,0.16),transparent_55%)] p-8 text-center sm:p-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
            ...
            {stats.mintPrice != null ? ` for ${formatEth(stats.mintPrice)}` : ""}, and hands you the
            key to the vault{vault ? ` — ${vault.prizeEth.toFixed(2)} ETH and counting` : ""}.
          </p>
